...
func closeFile(message string) string {
	message = "Read the user's request below, which asks for assistance with closing a file. Your task is to identify the name of the file and its type (e.g., txt, mp4, cvs) based solely on the provided input. Respond with the name of the file and its type, separated by a dot, like 'filename.txt' or 'videoname.mp4'. If the request does not contain enough information to confidently determine both the name of the file and its type, respond with '0'. It is crucial that you provide a single response based on the user's current request, without offering additional examples, further explanations, or multiple attempts. Your response must consist of only the file name and type in the specified format or '0', directly addressing the user's request. \n User request" + message
...
func createFile(message string) string {
	message = "Read the user's request below, which asks for assistance with creating a file. Your task is to identify the name of the file and its type (e.g., txt, mp4, cvs) based solely on the provided input. Respond with the name of the file and its type, separated by a dot, like 'filename.txt' or 'videoname.mp4'. If the request does not contain enough information to confidently determine both the name of the file and its type, respond with '0'. It is crucial that you provide a single response based on the user's current request, without offering additional examples, further explanations, or multiple attempts. Your response must consist of only the file name and type in the specified format or '0', directly addressing the user's request. \n User request" + message
...
func deleteFile(message string) string {
	message = "Read the user's request below, which asks for assistance with deleting a file. Your task is to identify the name of the file and its type (e.g., txt, mp4, cvs) based solely on the provided input. Respond with the name of the file and its type, separated by a dot, like 'filename.txt' or 'videoname.mp4'. If the request does not contain enough information to confidently determine both the name of the file and its type, respond with '0'. It is crucial that you provide a single response based on the user's current request, without offering additional examples, further explanations, or multiple attempts. Your response must consist of only the file name and type in the specified format or '0', directly addressing the user's request. \n User request" + message
